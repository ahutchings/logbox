...
<head>
    ...
    <link rel="stylesheet" href="<?php echo Logbox::theme_path() ?>css/yuiapp.css" type="text/css">
    <link id="theme" rel="stylesheet" href="<?php echo Logbox::theme_path() ?>css/tan_blue.css" type="text/css">
</head>
<body class="">
    <div id="doc3" class="yui-t6">
        ...
        <div id="bd">
            <div id="yui-main">
                <div class="yui-b"><div class="yui-g">
                    <h2>Hello, there.</h2>
                    <p><a href="http://github.com/tylerhall/yui-app-theme/">YUI App Theme</a> is a generic, skinnable layout for web applications.</p>
        ...
        <div id="ft">
            <p class="inner">Copyright &copy; 2009 Logbox</p>
        </div>
